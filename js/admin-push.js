...
(function (global) {
  ...
  async function refreshUi() {
    ...
    paint('off');
    setHint('לחצו «הפעל התראות» בטלפון הזה ואשרו. בלי זה לא יגיעו התראות מטבח, הזמנת מקום ושירות לקוחות כשהאדמין סגור. באייפון: הוסיפו את האדמין למסך הבית ואז הפעילו.');
  }
