...
(function () {
  ...
  const COPY = {
    en: {
      ...
      takeAwayHintWithDelivery: 'Pickup from the restaurant or delivery (€10, about 1.5 hours) · min. order €75',
      deliveryOrder: 'Delivery',
      deliveryOrderHint: 'Delivery €10 · about 1.5 hours · minimum order €75',
    ...
    he: {
      ...
      takeAwayHintWithDelivery: 'איסוף מהמסעדה או משלוח בעלות €10 · זמן משלוח כשעה וחצי · מינימום הזמנה €75',
      deliveryOrder: 'משלוח',
      deliveryOrderHint: 'משלוח בעלות €10 · זמן משלוח כשעה וחצי · מינימום הזמנה €75',
