...
const TRANSLATIONS = {
  he: {
    ...
    butcherCheckoutHint: 'לשליחת ההזמנה נדרשים שם, טלפון ומועד איסוף',
    ...
    butcherCheckoutDateRequired: 'נא לבחור תאריך איסוף',
    butcherCheckoutTimeRequired: 'נא לבחור שעת איסוף',
  ...
  en: {
    ...
    butcherCheckoutHint: 'Name, phone and pickup time are required to send the order',
    ...
    butcherCheckoutDateRequired: 'Please choose a pickup date',
    butcherCheckoutTimeRequired: 'Please choose a pickup time',
