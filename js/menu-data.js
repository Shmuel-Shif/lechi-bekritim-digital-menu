...
const MENU_DATA = {
  ...
  categories: [
    ...
    },
    {
      ...
      items: [
        { id: 'coke', name: 'קוקה קולה', description: '', price: 3, image: dishImage('coke') },
        { id: 'coke-zero', name: 'קולה זירו', description: '', price: 3, image: dishImage('coke-zero') },
        { id: 'fanta', name: 'פאנטה', description: '', price: 3, image: dishImage('fanta') },
        { id: 'sprite', name: 'ספרייט', description: '', price: 3, image: dishImage('sprite') },
        { id: 'red-bull', name: 'רד בול', description: '', price: 3, image: dishImage('red-bull') },
        { id: 'heineken', name: 'בירה הייניקן', description: '', price: 4, image: dishImage('heineken') },
        { id: 'corona', name: 'בירה קורונה', description: '', price: 4, image: dishImage('corona') },
        { id: 'soda', name: 'סודה', description: '', price: 3, image: dishImage('soda') },
        { id: 'water', name: 'מים מינרליים', description: '', price: 3, image: dishImage('water') },
        {
          id: 'fruit-shake',
...
const HOT_SIDE_ITEMS = [
  ...
  { id: 'rice', name: 'אורז לבן', description: '', price: 0, image: dishImage('white-rice') },
  { id: 'green-beans', name: 'שעועית ירוקה', description: '', price: 0, image: dishImage('green-beans') },
  { id: 'puree', name: 'פירה', description: '', price: 0, image: dishImage('puree') },
