...
const TRANSLATIONS = {
  he: {
    ...
    googleReviewTitle: 'תודה!',
    googleReviewHint: 'אם נהניתם, ביקורת בגוגל עוזרת מאוד למסעדה.',
  ...
  en: {
    ...
    googleReviewTitle: 'Thank you!',
    googleReviewHint: 'If you enjoyed your meal, a Google review helps the restaurant a lot.',
  ...
  el: {
    ...
    googleReviewTitle: 'Ευχαριστούμε!',
    googleReviewHint: 'Αν σας άρεσε, μια κριτική στο Google βοηθά πολύ το εστιατόριο.',
