...
const TRANSLATIONS = {
  he: {
    ...
    tableOrderBtn: 'הזמנת השולחן',
    tableOrderTitle: 'הזמנת שולחן {n}',
    tableOrderEmpty: 'עדיין לא נשלחו הזמנות לשולחן',
    openTableOrder: 'פתח את הזמנת השולחן',
    ...
    total: 'סה״כ',
    cartNowTotal: 'סה״כ בעגלה',
    currentTotal: 'סה״כ ההזמנה',
    tableGrandTotal: 'סה״כ השולחן',
    clearCart: 'נקה עגלה',
    ...
    receiptDelivery: 'משלוח',
    receiptOrderNo: 'מספר הזמנה',
    receiptRememberNo: 'המסעדה מיד תיצור איתכם קשר על מנת לאשר את ההזמנה',
    receiptNeedHelp: 'צריכים עזרה?',
    receiptPickupAsap: 'איסוף: בהקדם',
    receiptPickupAt: 'איסוף: {time}',
    receiptDeliveryAsap: 'משלוח: בהקדם',
    receiptDeliveryAt: 'משלוח: {time}',
    receiptDeliveryDate: 'תאריך משלוח: {date}',
    receiptDeliveryTime: 'שעת משלוח: {time}',
    ...
    stockLimit: 'נשארו רק {n} במלאי',
    stockGoneModal: 'נגמר במלאי.\nנשארו רק {n}',
    stockGoneModalZero: 'נגמר במלאי',
    stockLimitOk: 'הבנתי',
    decrease: 'הפחת כמות',
    increase: 'הוסף כמות',
    close: 'סגור',
    ...
    dineInNotesTitle: 'הערות למנה',
    dineInNotesHint: 'כתבו בקשה למסעדה. אפשר לשלוח את ההזמנה גם בלי הערה.',
    dineInNotesSubmit: 'שמור',
    dineInNotesBtn: 'הערות למנה',
  ...
  en: {
    ...
    tableOrderBtn: 'Table Order',
    tableOrderTitle: 'Table {n} Order',
    tableOrderEmpty: 'No orders have been sent for this table yet',
    openTableOrder: 'Open the table order',
    ...
    total: 'Total',
    cartNowTotal: 'In cart',
    currentTotal: 'Order total',
    tableGrandTotal: 'Table total',
    ...
    receiptNeedHelp: 'Need help?',
    receiptPickupAsap: 'Pickup: ASAP',
    receiptPickupAt: 'Pickup: {time}',
    receiptDeliveryAsap: 'Delivery: ASAP',
    receiptDeliveryAt: 'Delivery: {time}',
    receiptDeliveryDate: 'Delivery date: {date}',
    receiptDeliveryTime: 'Delivery time: {time}',
    ...
    stockLimit: 'Only {n} left',
    stockGoneModal: 'Out of stock.\nOnly {n} left',
    stockGoneModalZero: 'Out of stock',
    stockLimitOk: 'Got it',
    ...
    dineInNotesTitle: 'Dish notes',
    dineInNotesHint: 'Add a request for the restaurant. You can send the order without a note.',
    dineInNotesSubmit: 'Save',
    dineInNotesBtn: 'Dish notes',
    ...
    helpBotAnswerOrderShared: 'Choose your table number, add the dishes you want to the cart, and send the order.\n\nEach guest can order on their own. All orders are added to the same table, and you can still add more dishes later.',
    helpBotAnswerHours: '{days} · {hours}\nClosed Fri–Sat.',
    helpBotAnswerLocation: 'Analipsi 700 14, Greece',
  ...
  el: {
    cartNowTotal: 'Στο καλάθι',
    currentTotal: 'Σύνολο παραγγελίας',
    tableGrandTotal: 'Σύνολο τραπεζιού',
