...
(function (global) {
  ...
  const SHABBAT_TRANSLATIONS = {
    he: {
      ...
      closedText: 'ניתן להזמין שוב החל מיום ראשון.',
      adminClosedTitle: 'ההזמנות לשבת סגורות',
      adminClosedText: 'ניתן להזמין שוב החל מיום ראשון.',
      closedBrowse: 'לצפייה בתפריט',
      closedBack: 'חזרה',
      customerName: 'שם הלקוח *',
      customerPhone: 'טלפון *',
      customerNotes: 'הערות (אופציונלי)',
      pickupFixed: 'איסוף ביום שישי בשעה 14:00',
      noticeTitle: 'שימו לב',
      contact: 'יצירת קשר',
    ...
    en: {
      ...
      adminClosedTitle: 'Shabbat orders are closed',
      adminClosedText: 'You can order again starting Sunday.',
      closedBrowse: 'View the menu',
      closedBack: 'Back',
      customerName: 'Customer name *',
      customerPhone: 'Phone *',
      customerNotes: 'Notes (optional)',
      pickupFixed: 'Pickup on Friday at 14:00',
  ...
  const SHABBAT_MENU_DATA = {
    ...
    notes: [
      {
        he: 'איסוף ביום שישי בשעה 14:00',
        en: 'Pickup on Friday at 14:00',
      },
    ],
    categories: [
      {
      ...
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            name: 'תבשיל פויקה של לחיים',
            nameEn: "Lechaim's poyke stew",
            printName: 'Poyke Lechaim',
            desc: '',
            price: 24,
          ...
          },
          {
            ...
            printName: 'Asado',
            desc: 'מנה ל־3 אנשים. 600 גרם',
            descEn: 'A dish for 3 people. 600g',
            price: 67,
      ...
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            nameEn: 'Oven-baked potatoes',
            printName: 'Baked Potatoes',
            desc: '',
            price: 40,
            image: sabatImage('baked-potatoes'),
          },
          {
            id: 'shabbat-fries',
            name: "צ'יפס",
